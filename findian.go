...
// character ‘a’. The program should print “Not Found!” otherwise. The program should not
// be case-sensitive, so it does not matter if the characters are upper-case or lower-case.
...
func main() {
	...
	if first == 'i' && last == 'n' && strings.Contains(name, "a") {
		fmt.Printf("Found!")
	} else {
